...
{ 
    public class BescomParser
    {
        ...
        public static BescomSet stlma;
        public static BescomSet NonDasstsp;
        ...
        public static GenericTable ICCPCfg_Tbl { get; set; }  // Table for RTU_Control
        public static GenericTable Substation_names { get; set; }

        public static GenericTable RMU { get; set; }  // Table for RTU_Control

        public static GenericTable LRC { get; set; }  // Table for RTU_Control
        public static GenericTable LBS { get; set; }
        ...
        public BescomParser(string inputDir)
        {
            ...
            stsdSet = ParseSet(Path.Combine(inputDir, "STSD"));
            ...
            tlmaSet = ParseSet(Path.Combine(inputDir, "TLMA")); 
            ...
            stlma = ParseSet(Path.Combine(inputDir, "STLMA"));
            NonDasstsp= ParseSet(Path.Combine(inputDir, "NonDasSTSP"));
            ...
            StateRec_Tbl123 = new GenericTable(Path.Combine(inputDir, "StateRectbl123.csv"), "RECORD3", ',', '\"');
            ICCPCfg_Tbl = new GenericTable(Path.Combine(inputDir, "iccp_cfg_07112023.csv"), "station", ',', '\"');
            RMU = new GenericTable(Path.Combine(inputDir, "RMU.csv"), "name", ',', '\"');
            LRC = new GenericTable(Path.Combine(inputDir, "LRC.csv"), "name", ',', '\"');
            LBS = new GenericTable(Path.Combine(inputDir, "LBS.csv"), "name", ',', '\"');
